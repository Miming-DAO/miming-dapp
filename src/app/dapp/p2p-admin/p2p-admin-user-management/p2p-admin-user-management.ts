...
@Component({
  selector: 'app-p2p-admin-user-management',
  imports: [
    CommonModule,
    FormsModule,
    PDialogModule,
  ...
  templateUrl: './p2p-admin-user-management.html',
  styleUrl: './p2p-admin-user-management.css',
})
export class P2pAdminUserManagement {
  constructor() { }
